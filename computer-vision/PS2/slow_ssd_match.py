...
def stereo_match(left_img, right_img, kernel, max_offset):
    ...
    # Depth (or disparity) map.msg
    depth = np.zeros((w, h), np.uint8)
    depth.shape = h, w

    kernel_half = int(kernel / 2)
    offset_adjust = 255 / max_offset  # this is used to map.msg depth map.msg output to 0-255 range
...
if __name__ == '__main__':
    stereo_match("Data/proj2-pair1-L.png", "Data/proj2-pair1-R.png", 6, 30)  # 6x6 local search kernel, 30 pixel search range
